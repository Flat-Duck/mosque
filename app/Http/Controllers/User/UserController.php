...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.users.add', compact('designationOptions', 'descriptionOptions', 'certificateOptions', 'mosques', 'nationalities', 'genders'));
    }
    ...
    public function store()
    {
        ...
        return redirect()->route('user.users.index')->with([
            'type' => 'success',
    ...
    public function edit(User $user)
    {
        ...
        return view('user.users.edit', compact('teacher', 'designationOptions', 'descriptionOptions', 'certificateOptions', 'mosques', 'nationalities', 'genders'));
    }
